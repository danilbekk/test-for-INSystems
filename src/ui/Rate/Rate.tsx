...
const Rate: React.FC<RateProps> = ({ onUp, onDown, currentRate, isUpped, isDowned }) => (
  <>
    <Button onClick={onUp} style={{ color: isUpped ? 'green' : 'inherit' }}>
      <svg width="14" height="8" viewBox="0 0 14 8" xmlns="http://www.w3.org/2000/svg">
        <path
          fill={isUpped ? 'green' : 'inherit'}
          fillRule="evenodd"
          clipRule="evenodd"
    ...
    <Typography
      variant="body1"
      style={{ margin: '0 5px', color: currentRate > 0 ? 'green' : currentRate < 0 ? 'red' : 'inherit' }}>
      {currentRate}
    </Typography>
    <Button onClick={onDown} style={{ color: isDowned ? 'red' : 'inherit' }}>
      <svg width="14" height="8" viewBox="0 0 14 8" xmlns="http://www.w3.org/2000/svg">
        <path
          fill={isDowned ? 'red' : 'inherit'}
          fillRule="evenodd"
          clipRule="evenodd"
